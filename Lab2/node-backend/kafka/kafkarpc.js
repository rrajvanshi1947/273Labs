...
//     //subscribe to messages based on topic name
//     // switch(topic_name){
//     //     case 'traveler-login':
//     //     var consumer = self.connection.getConsumer('traveler-login-response');
//     //     // response_topic_name = 'traveler-login-response'
//     //     break
//     //     case 'owner-login':
//     //     var consumer = self.connection.getConsumer('owner-login-response');
//     //     break
//     //     case 'signup-traveler':
//     //     var consumer = self.connection.getConsumer('signup-traveler-response');
//     //     break
//     //     case 'signup-owner':
//     //     var consumer = self.connection.getConsumer('signup-owner-response');
//     //     break
//     //     default:
//     //     {}
//     // }
