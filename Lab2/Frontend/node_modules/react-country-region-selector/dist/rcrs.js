...
var filterCountries = function filterCountries(countries, whitelist, blacklist) {
...
var CountryDropdown = function (_Component) {
	...
	function CountryDropdown(props) {
		...
		_this.state = {
			countries: filterCountries(CountryRegionData, props.whitelist, props.blacklist)
		};
		return _this;
	}
	...
	createClass(CountryDropdown, [{
		...
		value: function render() {
			...
			var _props3 = this.props,
			    ...
			    arbitraryProps = objectWithoutProperties(_props3, ['name', 'id', 'classes', 'value', 'onChange', 'onBlur', 'disabled', 'showDefaultOption', 'defaultOptionLabel', 'labelType', 'valueType', 'whitelist', 'blacklist']);
...
var RegionDropdown = function (_Component) {
	...
	createClass(RegionDropdown, [{
		...
		value: function getDefaultOption() {
			var _props2 = this.props,
			    blankOptionLabel = _props2.blankOptionLabel,
			    showDefaultOption = _props2.showDefaultOption,
			    defaultOptionLabel = _props2.defaultOptionLabel,
		...
		value: function render() {
			var _props3 = this.props,
			    ...
			    labelType = _props3.labelType,
			    valueType = _props3.valueType,
			    countryValueType = _props3.countryValueType,
			    disableWhenEmpty = _props3.disableWhenEmpty,
			    arbitraryProps = objectWithoutProperties(_props3, ['value', 'country', 'onChange', 'onBlur', 'id', 'name', 'classes', 'disabled', 'blankOptionLabel', 'showDefaultOption', 'defaultOptionLabel', 'labelType', 'valueType', 'countryValueType', 'disableWhenEmpty']);
