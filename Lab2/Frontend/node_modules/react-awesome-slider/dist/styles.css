...
.aws-sld__bar {
  ...
  transition: transform 3s var(--transition-bezier),
    -webkit-transform 3s var(--transition-bezier);
  -webkit-transform: translate3d(-100%, 0, 0);
  transform: translate3d(-100%, 0, 0);
}
.aws-sld__bar--active {
...
.aws-sld--animated {
  -webkit-transition: -webkit-transform var(--slider-transition-duration)
    var(--transition-bezier);
  transition: -webkit-transform var(--slider-transition-duration)
    var(--transition-bezier);
...
.aws-sld__controls__arrow-right:before {
  ...
  right: calc(
    50% -
      (0.7071 * (var(--organic-arrow-height) + var(--organic-arrow-thickness))) /
      2
  );
  height: 100%;
